...
public abstract class FormElementThemeItem extends ThemeItemBase {
	...
	abstract public void textElement(String p_idDom,String p_name,Object p_value,int p_maxLength) throws IOException;
	...
	abstract public void textArea(String p_idDom,String p_name,String p_height,String p_width,Object p_value) throws IOException;
	public abstract void dateElement(String p_domId,String p_name,Object l_value) throws IOException;
